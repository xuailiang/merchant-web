    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () => import('../pages/InventoryCenter.vue'),
          meta: {
            title: '库存中心',
        ...
        },
        {
          ...
          component: () => import('../pages/MarketingAttribution.vue'),
          meta: {
            title: '营销归因',
        ...
        {
          path: 'ops/messages',
          name: 'OpsMessageCenter',
          component: () => import('../pages/OpsMessageCenter.vue'),
          meta: {
            title: '消息中心',
            key: 'ops-messages',
            parentKey: 'ops-root',
        ...
        },
        {
          ...
          meta: {
            title: '财务中心',
            key: 'finance',
            parentKey: 'finance-root',
            requiresAuth: true,
            roles: ['admin', 'finance'],
          } as RouteMeta,
        },
        {
          path: 'finance/closure',
          name: 'FinanceClosure',
          component: () => import('../pages/FinanceClosure.vue'),
          meta: {
            title: '资金闭环',
            key: 'finance-closure',
            parentKey: 'finance-root',
        ...
        {
          path: 'settings/open-platform',
          name: 'OpenPlatform',
          component: () => import('../pages/OpenPlatform.vue'),
          meta: {
            title: '开放平台',
            key: 'settings-open-platform',
            parentKey: 'settings-root',
            requiresAuth: true,
            roles: ['admin'],
          } as RouteMeta,
