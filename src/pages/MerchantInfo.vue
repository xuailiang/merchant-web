        ...
        <a-row :gutter="16">
          <a-col :xs="24" :lg="16">
            <a-form-item label="营业执照上传" required>
              <a-upload list-type="picture-card" :file-list="licenseFiles" :before-upload="() => false">
                <div v-if="licenseFiles.length < 1">
                  <PlusOutlined />
                  <div style="margin-top: 8px">上传</div>
                </div>
              </a-upload>
              <div class="help-text">最多支持1张,须原件拍照上传，附件仅支持jpg、jpeg、png、bmp图片格式</div>
            </a-form-item>
          </a-col>
          <a-col :xs="24" :lg="8">
        ...
        <a-row :gutter="16">
          ...
          <a-col :xs="24" :md="8">
            <a-form-item label="登记类型">
              <a-select v-model:value="operator.registerType" :options="registerTypeOptions" placeholder="请选择" />
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          ...
          <a-col :xs="24" :md="6">
            <a-form-item label="货币单位">
              <a-select v-model:value="operator.currency" :options="currencyOptions" placeholder="请选择" />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :md="6">
            <a-form-item label="登记状态">
              <a-select v-model:value="operator.registerStatus" :options="statusOptions" placeholder="请选择" />
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col :xs="24" :md="14">
            <a-form-item label="经营场所行政区">
              <a-space>
                <a-select v-model:value="operator.province" :options="provinceOptions" placeholder="省" />
                <a-select v-model:value="operator.city" :options="cityOptions" placeholder="市" />
                <a-select v-model:value="operator.district" :options="districtOptions" placeholder="区" />
              </a-space>
            </a-form-item>
          </a-col>
          <a-col :xs="24" :md="10">
            <a-form-item label="市场主体类型">
              <a-select v-model:value="operator.entityType" :options="entityTypeOptions" placeholder="请选择" />
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col :xs="24" :md="12">
            <a-form-item label="经营类目">
              <a-select v-model:value="operator.categories" mode="multiple" :options="categoryOptions" />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :md="12">
        ...
        <a-row :gutter="16">
          <a-col :xs="24" :md="12">
            <a-form-item label="身份证" required>
              <a-upload list-type="picture-card" :file-list="idFiles" :before-upload="() => false">
                <div v-if="idFiles.length < 2">
                  <PlusOutlined />
                  <div style="margin-top: 8px">上传</div>
                </div>
              </a-upload>
              <div class="help-text">最多支持2张,须原件拍照上传，附件仅支持jpg、jpeg、png、bmp图片格式（依次上传正反面）</div>
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="16">
          <a-col :xs="24" :md="12">
            <a-form-item label="经营范围">
              <a-textarea v-model:value="operator.scope" :rows="3" placeholder="请输入经营范围" />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :md="12">
            <a-form-item label="免于市场主体登记自我声明信息(非必填)">
              <a-textarea v-model:value="operator.declare" :rows="3" placeholder="请输入声明信息" />
            </a-form-item>
          </a-col>
        </a-row>
            </a-card>
        ...
        <a-row :gutter="16">
          ...
          <a-col :xs="24" :md="8">
            <a-form-item label="电子商务类型">
              <a-select v-model:value="store.ecomType" :options="ecomOptions" placeholder="请选择" />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :md="8">
          ...
          <a-col :xs="24" :md="8">
            <a-form-item label="店铺类型">
              <a-select v-model:value="store.type" :options="storeTypeOptions" placeholder="请选择" />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :md="8">
        ...
        <a-row :gutter="16">
          ...
          <a-col :xs="24" :md="16">
            <a-form-item label="开户行名称">
              <a-input v-model:value="account.bankName" placeholder="例如：中国工商银行山东省大明湖支行" />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :md="8">
          ...
          <a-col :xs="24" :md="8">
            <a-form-item label="结算方式">
              <a-select v-model:value="account.settlement" :options="settlementOptions" placeholder="请选择" />
            </a-form-item>
          </a-col>
        </a-row>
            </a-card>
...
const licenseFiles = ref([{ uid: '1', name: 'license.png', status: 'done', url: 'https://picsum.photos/id/101/120/120' }])
const idFiles = ref([
...
const logoFiles = ref([{ uid: '1', name: 'logo.png', status: 'done', url: 'https://picsum.photos/id/104/120/120' }])
